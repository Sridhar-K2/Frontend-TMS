...
const CreateTask = ({ progress }) => {
    ...
    // The progress prop passed is a function which is called from the tasklist component where the CreateTask is being rendered.
                ...
                <>
                    <section className='create-task'>
                        ...
                        <form onSubmit={handleSubmit} className='create-task-form'>
                            ...
                            <textarea id='description' name='description' onChange={e => setDescription(e.target.value)} placeholder='You may optionally add a short description of your task/project'></textarea>
